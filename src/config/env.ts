...
export function loadConfig(): AppConfig {
  ...
  const recruiterMaxMessagesPerDay = positiveInteger("RECRUITER_MAX_MESSAGES_PER_DAY", process.env.RECRUITER_MAX_MESSAGES_PER_DAY ?? String(gmailDailySendLimit)); const recruiterMaxMessagesPerHour = positiveInteger("RECRUITER_MAX_MESSAGES_PER_HOUR", process.env.RECRUITER_MAX_MESSAGES_PER_HOUR ?? String(Math.ceil(gmailDailySendLimit / 24)));
