export type SourceId =
  | "google-jina" | "google-direct" | "bing-jina" | "bing-direct" | "duckduckgo-jina" | "duckduckgo-direct" | "startpage-jina" | "ecosia-jina"
...
export function sourceList(query: string): Source[] {
  ...
  const sources: Source[] = [
    ...
    { id: "duckduckgo-direct", url: `https://html.duckduckgo.com/html/?q=${q}` },
